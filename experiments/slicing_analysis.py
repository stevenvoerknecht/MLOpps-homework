# experiments/slicing_analysis.py
...
print("4. Monitoring only global metrics hides these failure modes, which is dangerous in deployment.")


# Voeg onderaan slicing_analysis.py toe
